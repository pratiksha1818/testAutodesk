...
public class TC_22DOnotCallBoxEnableOrNot {
@Test
	 ...
	 //login to page
		...
		//create contact 
  	   ...
  	   driver.findElement(By.xpath("//input[@class='crmButton small save']")).click();
  	     String Actualvalue = driver.findElement(By.id("mouseArea_Do Not Call")).getText();
  	   ...
  	   SoftAssert s=new SoftAssert();
  	    s.assertEquals(Actualvalue, Expextedvalue);
