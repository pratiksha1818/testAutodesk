...
public class TC_25NotifyOwnerBoxIsEnableOrNot {
	@Test
	public void notifyownerboxisenableornot() throws Throwable {
		WebDriver driver=null;
		 ...
		 //choose browser
		  ...
		  String Actualvalue = driver.findElement(By.id("mouseArea_Notify Owner")).getText();
		  System.out.println(Actualvalue);
		  System.out.println(Expextedvalue);
